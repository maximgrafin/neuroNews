...
var store;
$testGroup('SQLiteStore - delete tests').beforeEachAsync(function() {
...
}), $test('id of type int').checkAsync(function() {
  var row1 = {
    id: 101,
    prop1: 100,
    prop2: 200
...
}), $test('record not found').checkAsync(function() {
  var row = {
    id: 'id1',
    description: 'something'
  };
...
}), $test('list of records - few exist, few do not').checkAsync(function() {
  var row1 = {
    id: 'abc',
    description: 'something'
  },
...
}), $test('id specified as undefined').checkAsync(function() {
  var row = {
    id: 'id1',
    description: 'something'
  };
...
}), $test('id not specified').checkAsync(function() {
  return store.defineTable({
    name: storeTestHelper.testTableName,
    columnDefinitions: {
      id: MobileServiceSqliteStore.ColumnType.String,
...
}), $test('a single invalid id').checkAsync(function() {
  var row = {
    id: 'someid',
    prop1: 100,
    prop2: 200
...
}), $test('array of ids containing an invalid id').checkAsync(function() {
  var row = {
    id: 'validid',
    prop1: 100,
    prop2: 200
...
}), $test('invoked without any argument').checkAsync(function() {
  return store.defineTable({
    name: storeTestHelper.testTableName,
    columnDefinitions: {
      id: MobileServiceSqliteStore.ColumnType.Text,
...
}), $test('argument is a basic query').checkAsync(function() {
  var row1 = {
    id: 'someid1',
    prop1: 'abc',
    prop2: 200
...
}), $test('argument is a query whose result contains id column').checkAsync(function() {
  var row1 = {
    id: 'someid1',
    prop1: 'abc',
    prop2: 200
...
}), $test('argument is a query whose result does not contain id column').checkAsync(function() {
  var row1 = {
    id: 'someid1',
    prop1: 'abc',
    prop2: 200
...
}), $test('argument is a complex MobileServiceQuery').checkAsync(function() {
  var row1 = {
    id: 'someid1',
    prop1: 'a',
    prop2: 100
...
}), $test('argument is a query matching no records').checkAsync(function() {
  var row1 = {
    id: 'someid1',
    prop1: 'a',
    prop2: 100
...
}), $test('argument is a query matching record with null / undefined properties').checkAsync(function() {
  var row = {
    id: 'someid',
    prop1: undefined,
    prop2: null
...
}), $test('invoked with query and extra parameters').description('Check that promise returned by upsert is either resolved or rejected even when invoked with extra parameters').checkAsync(function() {
  var row1 = {
    id: 'someid1',
    prop1: 100,
    prop2: 200
