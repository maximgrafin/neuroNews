...
$testGroup('SQLiteStore - upsert tests').beforeEachAsync(function() {
  return storeTestHelper.createEmptyStore().then(function(emptyStore) {
    store = emptyStore;
  });
}).tests($test('table is not defined').checkAsync(function() {
  var row = {
    id: 101,
...
}), $test('insert new record and then update it').checkAsync(function() {
  var row = {
    id: 'some id',
    price: 100
  };
...
}), $test('array of records, all having the same id').checkAsync(function() {
  var rows = [{
    id: 't1',
...
}), $test('update property of an existing record').checkAsync(function() {
  return store.defineTable({
    name: storeTestHelper.testTableName,
    columnDefinitions: {
      id: MobileServiceSqliteStore.ColumnType.String,
...
}), $test('verify id case sensitivity').checkAsync(function() {
  var row1 = {
    id: 'ABC',
    description: 'old'
  },
...
}), $test('insert array of records containing a null object').checkAsync(function() {
  var row = {
    id: 'ABC',
...
}), $test('insert array of records containing an undefined object').checkAsync(function() {
  var row = {
    id: 'ABC',
    description: 'something'
  };
...
}), $test('empty table name').checkAsync(function() {
  return store.defineTable({
    name: storeTestHelper.testTableName,
    columnDefinitions: {
      id: MobileServiceSqliteStore.ColumnType.Text,
...
}), $test('empty array').checkAsync(function() {
  return store.defineTable({
    name: storeTestHelper.testTableName,
    columnDefinitions: {
      id: MobileServiceSqliteStore.ColumnType.Text,
...
}), $test('record is null').checkAsync(function() {
  return store.defineTable({
    name: storeTestHelper.testTableName,
    columnDefinitions: {
      id: MobileServiceSqliteStore.ColumnType.Text,
...
}), $test('record is undefined').checkAsync(function() {
  return store.defineTable({
    name: storeTestHelper.testTableName,
    columnDefinitions: {
      id: MobileServiceSqliteStore.ColumnType.Text,
...
}), $test('adding record with columns that are not defined should succeed').checkAsync(function() {
  var row = {
    id: 101,
    flag: 51,
    undefinedColumn: 1
...
}), $test('adding record with incorrect column type should fail').checkAsync(function() {
  var row = {
    id: 101,
    flag: [1, 2]
  },
...
}), $test('record is not an object').checkAsync(function() {
  return store.defineTable({
    name: storeTestHelper.testTableName,
    columnDefinitions: {
      id: MobileServiceSqliteStore.ColumnType.String,
...
}), $test('record does not have an id property').checkAsync(function() {
  return store.defineTable({
    name: storeTestHelper.testTableName,
    columnDefinitions: {
      id: MobileServiceSqliteStore.ColumnType.String,
...
}), $test('record id is null').description('Check that promise returned by upsert is either resolved or rejected even when id is null').checkAsync(function() {
  return store.defineTable({
    name: storeTestHelper.testTableName,
    columnDefinitions: {
      id: MobileServiceSqliteStore.ColumnType.String,
...
}), $test('record id is defined as undefined').description('Check that promise returned by upsert is either resolved or rejected even when id is undefined').checkAsync(function() {
  return store.defineTable({
    name: storeTestHelper.testTableName,
    columnDefinitions: {
      id: MobileServiceSqliteStore.ColumnType.String,
...
}), $test('record does not have an id').description('Check that promise returned by upsert is either resolved or rejected even when id is missing').checkAsync(function() {
  return store.defineTable({
    name: storeTestHelper.testTableName,
    columnDefinitions: {
      id: MobileServiceSqliteStore.ColumnType.String,
...
}), $test('ID property not the first property that gets enumerated').checkAsync(function() {
  var record = {
    a_prop1: 100,
    id: 'someid',
    z_prop2: 200
...
}), $test('invoked with extra arguments').description('Check that promise returned by upsert is either resolved or rejected even when invoked with extra parameters').checkAsync(function() {
  return store.defineTable({
    name: storeTestHelper.testTableName,
    columnDefinitions: {
      id: MobileServiceSqliteStore.ColumnType.String,
...
}), $test('invoked without any arguments').checkAsync(function() {
  return store.defineTable({
    name: storeTestHelper.testTableName,
    columnDefinitions: {
      id: MobileServiceSqliteStore.ColumnType.Text,
...
}), $test('verify serialization error is handled properly').checkAsync(function() {
  return store.defineTable({
    name: storeTestHelper.testTableName,
    columnDefinitions: {
      id: MobileServiceSqliteStore.ColumnType.String,
