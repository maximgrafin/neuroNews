...
$testGroup('Extensions.js', $test('isNull').description('Verify Extensions.isNull works correctly across null/undefined/etc.').check(function() {
...
}), $test('isNullOrEmpty').description('Verify Extensions.isNullOrEmpty works correctly across null/undefined/empty/etc.').check(function() {
...
}), $test('isValidId').description('Verify isValidId works correctly across id types').check(function() {
...
}), $test('format').description('Verify Extensions.format').check(function() {
  ...
  $assertThrows(function() {
    Extensions.format(12);
  }, function(ex) {
    $assert.contains(ex.toString(), 'message');
  }, 'format did not throw for non-string message value.');
  $assert.areEqual(Extensions.format('{0}{1}', 0), '0{1}');
  $assert.areEqual(Extensions.format('{0}{1}', '{1}', 'X'), 'XX');
  $assert.areEqual(Extensions.format('{{0}}', '1', 'X'), 'X');
}), $test('has').description('Verify Extensions.has').check(function() {
  $assertThrows(function() {
    Extensions.has(null, null);
  });
  $assertThrows(function() {
    Extensions.has(null, 2);
  });
...
}), $test('isObject').description('Verify Extensions.isObject').check(function() {
...
}), $test('isString').description('Verify Extensions.isString').check(function() {
...
}), $test('isNumber').description('Verify Extensions.isNumber').check(function() {
...
}), $test('isBool').description('Verify Extensions.isBool').check(function() {
...
}), $test('isDate').description('Verify Extensions.isDate').check(function() {
...
}), $test('isInteger').description('Verify Extensions.isFunction').check(function() {
...
}), $test('isFunction').description('Verify Extensions.isFunction').check(function() {
...
}), $test('isArray').description('Verify Extensions.isArray').check(function() {
...
}), $test('toJson').description('Verify Extensions.toJson').check(function() {
  $assert.areEqual('{"a":1}', Extensions.toJson({a: 1}));
}), $test('fromJson').description('Verify Extensions.fromJson').check(function() {
...
}), $test('createUniqueInstallationId').description('Verify Extensions.createUniqueInstallationId').check(function() {
  $assert.areNotEqual(Extensions.createUniqueInstallationId(), Extensions.createUniqueInstallationId());
}), $test('mapProperties').description('Verify Extensions.mapProperties').check(function() {
  var obj = {
    foo: 1,
    bar: 2
  };
  var results = Extensions.mapProperties(obj, function(k, v) {
    return k + '=' + v;
  }).join(',');
  $assert.areEqual(results, 'foo=1,bar=2');
}), $test('pad').description('Verify Extensions.pad').check(function() {
  $assertThrows(function() {
    Extensions.pad(null, 1, '0');
  });
  $assertThrows(function() {
    Extensions.pad(1, 'fasdfas', '0');
  });
  $assertThrows(function() {
    Extensions.pad(1, 1, 1);
  });
  $assertThrows(function() {
    Extensions.pad(1, 1, null);
  });
  $assertThrows(function() {
    Extensions.pad(1, 1, 'abc');
  });
...
}), $test('trimEnd').description('Verify Extensions.trimEnd').check(function() {
  $assertThrows(function() {
    Extensions.trimEnd(null, '1');
  });
  $assertThrows(function() {
    Extensions.trimEnd(1, '1');
  });
  $assertThrows(function() {
    Extensions.trimEnd('foo', null);
  });
  $assertThrows(function() {
    Extensions.trimEnd('foo', 1);
  });
  $assertThrows(function() {
    Extensions.trimEnd('foo', 'abc');
  });
  ...
  $assert.areEqual('', Extensions.trimEnd('///', '/'));
  $assert.areEqual('', Extensions.trimEnd('', '/'));
}), $test('trimStart').description('Verify Extensions.trimStart').check(function() {
  $assertThrows(function() {
    Extensions.trimStart(null, '1');
  });
  $assertThrows(function() {
    Extensions.trimStart(1, '1');
  });
  $assertThrows(function() {
    Extensions.trimStart('foo', null);
  });
  $assertThrows(function() {
    Extensions.trimStart('foo', 1);
  });
  $assertThrows(function() {
    Extensions.trimStart('foo', 'abc');
  });
  ...
  $assert.areEqual('', Extensions.trimStart('///', '/'));
  $assert.areEqual('', Extensions.trimStart('', '/'));
}), $test('compareCaseInsensitive').description('Verify Extensions.compareCaseInsensitive').check(function() {
...
}), $test('url.combinePathSegments').description('Verify Extensions.url.combinePathSegments').check(function() {
  $assertThrows(function() {
    Extensions.url.combinePathSegments();
  });
  $assertThrows(function() {
    Extensions.url.combinePathSegments(1);
  });
  $assertThrows(function() {
    Extensions.url.combinePathSegments('foo', 1);
  });
...
}), $test('url.getQueryString').description('Verify Extensions.url.getQueryString').check(function() {
  $assertThrows(function() {
    Extensions.url.getQueryString();
  });
  $assertThrows(function() {
    Extensions.url.getQueryString(1);
  });
  $assertThrows(function() {
    Extensions.url.getQueryString('foo');
  });
  $assert.areEqual('state=WA', Extensions.url.getQueryString({state: 'WA'}));
  $assert.areEqual('state=WA&code=5', Extensions.url.getQueryString({
    state: 'WA',
    code: 5
  }));
...
}), $test('url.combinePathAndQuery').description('Verify Extensions.url.combinePathAndQuery').check(function() {
  $assertThrows(function() {
    Extensions.url.combinePathAndQuery();
  });
  $assertThrows(function() {
    Extensions.url.combinePathAndQuery(1);
  });
  $assertThrows(function() {
    Extensions.url.combinePathAndQuery('foo', 1);
  });
  $assert.areEqual('\\somePath?someQuery=true', Extensions.url.combinePathAndQuery('\\somePath', 'someQuery=true'));
  $assert.areEqual('\\somePath?someQuery=true', Extensions.url.combinePathAndQuery('\\somePath', '?someQuery=true'));
}), $test('url.isAbsoluteUrl').description('Verify Extensions.url.isAbsoluteUrl').check(function() {
...
}), $test('tryParseIsoDateString').description('Verify Extensions.tryParseIsoDateString').check(function() {
  $assertThrows(function() {
    Extensions.tryParseIsoDateString(1);
  });
  $assertThrows(function() {
    Extensions.tryParseIsoDateString(new Date());
  });
...
}), $test('createError').description('Verify the creation of error messages').check(function() {
  ...
  error = Extensions.createError(null, {
    status: 400,
  ...
  $assert.isNull(error.exception);
}), $test('installIdFormat').description('Verify the format of the installation ids').check(function() {
